<div id="footer" class="wrapper-dark">
    <div class="container" style="padding: 3rem 1.5rem;">
            ...
            <div class="w-100 w-md-50 d-sm-flex || w-full md:w-1/2 sm:flex">
                <div class="ul-container w-50 || w-1/2 text-left">
                    ...
                    <ul class="ps-0 || pl-0" style="list-style: none;">
                        ...
                        <li><a href="https://student-activity.binus.ac.id/himti/contact-us/">Contact Us</a></li>
                    </ul>
                </div>
                <div class="ul-container w-50 || w-1/2 text-left">
                    <p class="ul-label fw-bold fs-5 || font-bold text-xl" style="margin-bottom: 1rem;">Latest events</p>
                    <ul class="ps-0 || pl-0" style="list-style: none;">
                        <li><a href="https://hishot.himti.or.id">HISHOT 2021</a></li>
                        <li><a href="https://techno.himti.or.id">TECHNO 2021</a></li>
                        <li><a href="https://computerun.id">COMPUTERUN 2021</a></li>
                    </ul>
                </div>
            </div>
            <div class="w-md-50 d-flex justify-content-md-end || md:w-1/2 flex md:justify-end" style="margin-bottom: 1.5rem">
        ...
        <div class="d-sm-flex align-items-center justify-content-between || sm:flex items-center justify-between px-0 sm:px-4 lg:px-12">
