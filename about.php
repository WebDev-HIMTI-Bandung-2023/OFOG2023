        ...
        <div class="container">
            ...
            <div class="lg:flex py-6 lg:py-12 block">
                <div class="half border-b lg:border-b-0 lg:border-r border-gray-100 pb-12 w-full lg:w-1/2">
                    ...
                    <p class="p">"Menjadikan HIMTI BINUS University sebagai Himpunan Mahasiswa yang dikenal se-Asia
    ...
    <div style="overflow-x:hidden">
        <div class=" container px-0 xl:px-6" style="width: 100%">
            ...
            <div style="position: relative; display: flex; margin:auto; text-align: center; justify-content:center;">
                <div>
                    <img src="https://drive.google.com/uc?export=view&amp;id=1FmdaBjlrZW_cgXg4S7y3axD4sUuM1-D4" alt=""
                        class="block1Custom" />
                    ...
                    <a href="https://drive.google.com/uc?export=view&amp;id=1EqUY3YH6gfvf_36QdgDTg7veS0nmoaO8"
                        target="_blank"><img style=" display: flex; margin: auto; margin-bottom: 20px"
                            src="https://drive.google.com/uc?export=view&amp;id=1EqUY3YH6gfvf_36QdgDTg7veS0nmoaO8"
                            alt="" Class="Bagan" /></a>
                    <img src="https://drive.google.com/uc?export=view&amp;id=153-AvU6hNHdaEupGuxTIN5Q7dlWjap7v" alt=""
                        class="block2Custom" />
                    <img src="https://drive.google.com/uc?export=view&amp;id=14QHWPy4hmrci2V-8sr92cv8Ipl3bI7X_" alt=""
                        class="Light2Custom" />
                    <img src="https://drive.google.com/uc?export=view&amp;id=1r1ExWkUCvlM91L48H-LTnIrPdm-ZjSiN" alt=""
                        class="block3Custom" />
                    <img src="https://drive.google.com/uc?export=view&amp;id=1vhjg_dyP-yz5FPjO1OCGdc7i95YkPN4x" alt=""
                        class="block4Custom" />
                </div>
            </div>
        </div>
