...
<body>
    <<<<<<< HEAD=======<div id="Preloader">
        ...
        >>>>>>> 0d13386b94f4a6f90b5e6a9fd73008c74f139c38
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="testimonicarousel">
                            <div class="left row m-0">
                                ...
                                <div class="testimoniprofile col-12 col-md-9  mt-3 mt-md-0" col-xl-12 p-lg-3 mt-3
                                    mt-md-0">
                            ...
                            <div class="left row m-0">
                                <picture class="col-6 col-md-12 offset-sm-3 offset-md-0">
                                    <source srcset="assets/img/testimonies-thumbnail/BayuArdanaPhoto.webp"
                                        type="image/webp">
                                    <source srcset="assets/img/testimonies-thumbnail/BayuArdanaPhoto.png"
                                        type="image/png">
                            ...
                            <div class="left row m-0">
                                <picture class="col-6 col-md-12 offset-sm-3 offset-md-0">
                                    <source srcset="assets/img/testimonies-thumbnail/HanifKusumaPhoto.webp"
                                        type="image/webp">
                                    <source srcset="assets/img/testimonies-thumbnail/HanifKusumaPhoto.png"
                                        type="image/png">
                            ...
                            <div class="left row m-0">
                                <picture class="col-6 col-md-12 offset-sm-3 offset-md-0">
                                    <source srcset="assets/img/testimonies-thumbnail/KennyOngkoPhoto.webp"
                                        type="image/webp">
                                    <source srcset="assets/img/testimonies-thumbnail/KennyOngkoPhoto.png"
                                        type="image/png">
                    ...
                    <div class="carousel-item">
                        <div class="testimonicarousel">
                            <div class="left row m-0">
                                <picture class="col-6 col-md-12 offset-sm-3 offset-md-0">
                                    <source srcset="assets/img/testimonies-thumbnail/MesyellaPhoto.webp"
                                        type="image/webp">
                                    <source srcset="assets/img/testimonies-thumbnail/MesyellaPhoto.png"
                                        type="image/png">
            ...
            <div>
                <div id="circularMenu1" class="circular-menu circular-menu-left active">
                    ...
                    <button id="2" onclick="changeposition(this.id)" class="menu-item deg36">1994</button> -->
                        ...
                        <button id="3" onclick="changeposition(this.id)"
                            class="menu-item deg180 activetab">2011</button>
